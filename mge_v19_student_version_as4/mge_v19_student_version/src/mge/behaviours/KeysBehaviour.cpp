...
KeysBehaviour::KeysBehaviour(float pMoveSpeed, float pTurnSpeed, float pRisingSpeed) : AbstractBehaviour(), _moveSpeed(pMoveSpeed), _turnSpeed(pTurnSpeed), _risingSpeed(pRisingSpeed)
{
}
...
void KeysBehaviour::update( float pStep )
{
	...
	_owner->translate( glm::vec3(0.0f, risingSpeed*pStep, moveSpeed*pStep ));
