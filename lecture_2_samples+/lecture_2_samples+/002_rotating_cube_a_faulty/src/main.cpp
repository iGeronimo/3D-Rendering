...
int main () {
    ...
    while (window.isOpen()) {
        ...
        glm::mat4 modelMatrix = glm::translate (glm::vec3(0,0,-5)) * glm::rotate (clock()/1000.0f, glm::vec3(1,0,0)); 
        //glm::mat4 modelMatrix = glm::rotate (clock()/1000.0f, glm::vec3(0.7,0.7,0.7)) * glm::translate (glm::vec3(0,0,-5)); // * vertex 
